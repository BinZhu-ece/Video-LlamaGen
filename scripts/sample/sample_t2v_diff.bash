...
CUDA_VISIBLE_DEVICES=6 python3 autoregressive/sample/sample_t2v_1f_diff.py  \
    --vae-model  VAE-16 \
    --vae-ckpt ${CKPT} \
    ...
    --cfg-scale 1 \
    --num_frames 1 \
    --gpt-ckpt /storage/zhubin/LlamaGen/results_vae_1f_diff_flowers_1B/015-GPT-1B/checkpoints/0560000.pt  \
